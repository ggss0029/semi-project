    ...
    <div class="wrap">
        <div id="content">
        	...
        	<div id="content_2" align="center">
        		...
        		<%if(request.getAttribute("modalNickname")!=null){
        			String modalNickname = (String)request.getAttribute("modalNickname");%>
        			var modalNickname = "<%=modalNickname%>";
        			$("#receiver").val(modalNickname);
        		<%}%>
