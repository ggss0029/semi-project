	...
	<div class="wrap">
		<div id="content" align="center">
			<div id="content_1">
				...
				<br>
				<form id="enroll-form" name="form" action="<%=contextPath %>/noticeUpdate.bo" method="post">
				<input type="hidden" name="bno" value="<%=n.getNoticeNo() %>">
					<div id="writeTitle">
					...
					<div id="contentArea">
						<textarea name="content" id="boardContent" cols="30" rows="25"
							style="resize: none; font-size: 20px;"><%=n.getNoticeContent() %></textarea>
					</div>
					<br>
