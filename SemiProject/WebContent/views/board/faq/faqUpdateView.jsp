<%@page import="com.udong.board.faq.model.vo.FaqBoard"%>
...
<body>
	...
	<div class="wrap">
		<div id="content" align="center">
			<div id="content_1">
				<div id="doWrite">FAQ 작성</div>
				<br>
				<form id="enroll-form" name="form" action="<%=contextPath %>/faqUpdate.bo" method="post">
				<input type="hidden" name="bno" value="<%=fb.getFaqNo() %>">
					<div id="writeTitle">
						<input type="text" name="title" value="<%=fb.getFaqTitle() %>"
							style="width: 1348px; height: 60px; font-size: 18px;" required>
					</div>

					<div id="contentArea">
						<textarea name="content" id="boardContent" cols="30" rows="25"
							style="resize: none; font-size: 20px;"><%=fb.getFaqContent() %></textarea>
					</div>
					<br>
