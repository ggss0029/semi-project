        	...
        	<input type="hidden" name="userNickname" value="<%=loginUser.getNickname()%>">
                <div id="categoryBar" align="left">
                    ...
                    <script>
                        ...
                        ctgr[5] = new Array('전체','의류/잡화','뷰티','출산','아동','주방용품','생활용품','인테리어','가전/디지털','스포츠/레저','자동차용품','도서','음반','DVD','완구','문구','반려동물용품','헬스/건강식품','기타');
                        ctgr[6] = new Array('전체','의류/잡화','뷰티','출산','아동','주방용품','생활용품','인테리어','가전/디지털','스포츠/레저','자동차용품','도서','음반','DVD','완구','문구','반려동물용품','헬스/건강식품','기타');
