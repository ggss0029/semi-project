...
/**
 * Servlet implementation class WrittenBoardListController
 */
@WebServlet("/writtenBoardList.bo")
public class WrittenBoardListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WrittenBoardListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Member m = new MemberService().findNickname(request.getParameter("nickname"));
		...
		request.getRequestDispatcher("views/board/writtenBoardList.jsp").forward(request, response);
	}
