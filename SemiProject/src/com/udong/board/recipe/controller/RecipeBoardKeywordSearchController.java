 ...
 */
@WebServlet("/searchPosting.bo")
public class RecipeBoardKeywordSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecipeBoardKeywordSearchController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("keyword 잘 가져오니? 키워드서치 컨트롤러"+keyword);
		
		ArrayList<Board> list = new BoardService().selectListbyKeyword(pi, keyword);
		...
		request.getRequestDispatcher("/views/board/recipe/boardListViewByKeyword.jsp").forward(request, response);
