...
public class NewsAttachment {
	...
	public NewsAttachment(int fileNo, String originName, String changeName, String filePath) {
		super();
		this.fileNo = fileNo;
	...
	public NewsAttachment(int fileNo, int refBno, String originName, String changeName, String filePath,
	...
	public String toString() {
		return "NewsAttachment [fileNo=" + fileNo + ", refBno=" + refBno + ", originName=" + originName
