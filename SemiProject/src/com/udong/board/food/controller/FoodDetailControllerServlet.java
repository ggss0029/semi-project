 ...
 */
@WebServlet("/foodDetail.bo")
public class FoodDetailControllerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FoodDetailControllerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result>0) { 
			FoodBoard fb = new FoodBoardService().selectFoodBoardDetail(boardNo);
