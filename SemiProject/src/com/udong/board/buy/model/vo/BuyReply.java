...
public class BuyReply {
	...
	public BuyReply(int replyNo, int refBno, String replyWriter,  Date createDate, String replyContent) {
		super();
	...
	public BuyReply(int replyNo, int refBno, String replyWriter, String replyContent, Date createDate, Date modifyDate,
			String status) {
		super();
		this.replyNo = replyNo;
		this.refBno = refBno;
	...
	public String toString() {
		return "BuyReply [replyNo=" + replyNo + ", refBno=" + refBno + ", replyWriter=" + replyWriter
