package com.udong.board.clean.model.vo;
...
public class CleanBoard {
	...
	public CleanBoard(int boardNo, String boardWriter, String boardTitle, int count, Date createDate, int likeCount) {
		super();
		this.boardNo = boardNo;
		this.boardWriter = boardWriter;
		this.boardTitle = boardTitle;
	...
	public CleanBoard(int boardNo, String boardWriter, String boardTitle, String boardContent, String boardName,
	...
	public String toString() {
		return "CleanBoard [boardNo=" + boardNo + ", boardWriter=" + boardWriter + ", boardTitle=" + boardTitle
