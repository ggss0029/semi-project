...
/**
 * Servlet implementation class CleanListController
 */
@WebServlet("/cleanList.bo")
public class CleanListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CleanListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//페이징 처리
				...
				listCount = new CleanService().cleanSelectListCount();
//				System.out.println(listCount); //확인 완료
				...
				//clean(살림꿀팁) 전체 리스트를 조회해와서 request에 담아 위임.
				ArrayList<CleanBoard> clist = new CleanService().cleanSelectList(pi);
