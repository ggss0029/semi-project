...
public class TogetherReply {
	...
	public TogetherReply() {
		super();
	}

	public TogetherReply(int replyNo, int refBno, String replyWriter, String replyContent, Date createDate,
	...
	public String toString() {
		return "TogetherReply [replyNo=" + replyNo + ", refBno=" + refBno + ", replyWriter=" + replyWriter
